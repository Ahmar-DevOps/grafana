...
var packagePluginRunner = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var start, ciDir, packagesDir, distDir, docsDir, grafanaEnvDir, distContentDir, d, dirs, dirs_1, dirs_1_1, j, contents, er_1, e_2_1, pluginJsonFile, pluginInfo, _a, zipName, zipFile, zipStats, info, _b, p, _c, customIniBody;
    var e_2, _d;
    return tslib_1.__generator(this, function (_e) {
        switch (_e.label) {
            case 0:
            ...
            case 18:
                _e.sent();
                if (!fs_1.default.existsSync(docsDir)) return [3 /*break*/, 21];
